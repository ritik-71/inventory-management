...
export default function AddItemModal({ isOpen, onClose, onAdd }: AddItemModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onAdd(formData as unknown as Omit<InventoryItem, 'id' | 'dateAdded'>);
    setFormData({ 
      name: "", skuCode: "", brand: "", category: "Electronics", quantity: 0, unitType: "pcs", 
      purchasePrice: 0, sellingPrice: 0, supplier: "", supplierEmail: "", warehouseLocation: "", status: "IN_STOCK" 
    });
  };
        ...
        <form onSubmit={handleSubmit} className="modal-body">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            ...
            <div>
              ...
              <input type="text" className="input" value={formData.unitType} onChange={e => setFormData({...formData, unitType: e.target.value})} placeholder="e.g. pcs, boxes" />
            </div>
            <div>
